    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header" style="justify-content: space-between">
                @if (!count($data))
                    <a href="/setting/create" class="btn btn-success" style="color:white ;">Tambah Data</a>
                @endif
                                ...
                                <tr>
                                    @forelse ($data as $l)
                                        ...
                                        <td>
                                            <div class=" d-flex ">
                                                <div class="m-1">
                                                    <a href="/setting/{{ $l->id }}/edit" class="btn btn-warning"><i
                                                            class="fas fa-edit"></i></a>
                                                </div>
                                                <div class="m-1">
                                                    <form class="d-inline" action="/setting/{{ $l->id }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
